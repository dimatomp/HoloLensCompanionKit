...
#define CHESS_SQUARE_SIZE 0.048 // Width of the chess squares in meters = 2.66 inches.
...
#define HOLOLENS_ADDRESS L"http://192.168.15.58/"
#define HOLOLENS_USER L"dimatomp"
#define HOLOLENS_PW L"tompesecret"
